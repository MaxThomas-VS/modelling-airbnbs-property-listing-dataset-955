...
def make_args(parser=argparse.ArgumentParser()):
    ...
    parser.add_argument('--nn_config', type=str, required=False, default=None)
    parser.add_argument('--nn_epochs', type=int, required=False, default=50)
    parser.add_argument('--nn_val_split_size', type=float, required=False, default=0.2)
    parser.add_argument('--nn_single_config', type=str, required=False, default=None)
